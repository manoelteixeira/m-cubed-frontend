...
export default function LoansMarketplace({ user, token, loadLoanProposals }) {
  ...
  const handleSendProposal = async () => {
    // Handle "None" if no requirements are selected
    const requirementsToSend =
      lenderProposal.requirements.length > 0
        ? lenderProposal.requirements
        : ["None"];

    const proposalData = {
      ...lenderProposal,
      requirements: requirementsToSend,
      ...
      <Dialog open={openDialog} onClose={() => setOpenDialog(false)}>
        ...
        <DialogContent>
          ...
          <Typography variant="body2">
            ...
            {lenderProposal.requirements.join(", ") || "None"}
          </Typography>
        </DialogContent>
        <DialogActions>
...
// export default function LoansMarketplace({ user, token, loadLoanProposals }) {
//   const [loanListings, setLoanListings] = useState([]);
//   const [loanListingsLimit, setLoanListingsLimit] = useState(
//     JSON.parse(localStorage.getItem("loanListingsLimit")) || 10
//   );
//   const [loanListingsOffset, setLoanListingsOffset] = useState(
//     JSON.parse(localStorage.getItem("loanListingsOffset")) || 0
//   );
//   const [loanListingsTotal, setLoanListingsTotal] = useState(null);
//   const [loanListingsValue, setLoanListingsValue] = useState(0);
//   const [searchTermLoanListings, setSearchTermLoanListings] = useState(
//     localStorage.getItem("searchTermLoanListings") || ""
//   );
//   const [sortByLoanListings, setSortByLoanListings] = useState(
//     localStorage.getItem("sortByLoanListings") || "created_at"
//   );
//   const [sortOrderLoanListings, setSortOrderLoanListings] = useState(
//     localStorage.getItem("sortOrderLoanListings") || "desc"
//   );
//   const [expandedRowId, setExpandedRowId] = useState(null);
//   const [borrowerDetails, setBorrowerDetails] = useState({});
//   const [creditReports, setCreditReports] = useState([]);
...
//     setSearchTermLoanListings(value);
//     localStorage.setItem("searchTermLoanListings", value);
//   };
...
//     localStorage.setItem("sortByLoanListings", sortKey);
//     localStorage.setItem("sortOrderLoanListings", newOrder);
//   };
...
//             setLoanListingsOffset(newPage);
//             localStorage.setItem("loanListingsOffset", JSON.stringify(newPage));
//           }}
//           rowsPerPage={loanListingsLimit}
//           onRowsPerPageChange={(event) => {
//             setLoanListingsLimit(event.target.value);
