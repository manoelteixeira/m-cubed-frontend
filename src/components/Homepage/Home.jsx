...
import { CardContent, Button, Typography, Card, Grid, useTheme, useMediaQuery } from "@mui/material";
...
export default function Home() {
  ...
  return (
    ...
    >
      <Grid container spacing={isMobile ? 2 : isMedium ? 3 : 4} justifyContent="center" sx={{ padding: isMobile ? 2 : isMedium ? 3 : 5 }}>
        <Grid
          item
          xs={12}
          sm={12}
      ...
      {/* How This Works Section */}
      <Grid container spacing={isMobile ? 2 : isMedium ? 3 : 4} justifyContent="center" sx={{ padding: isMobile ? 2 : isMedium ? 3 : 18 }}>
        <Grid item xs={12} display="flex" justifyContent="center">
          <img
